...
const TournamentRegistrationScreen = ({ navigation }: Props) => {
  ...
  return (
    <Background>
      ...
      <Header>Tournament Registration.</Header>
...
export default memo(TournamentRegistrationScreen);
